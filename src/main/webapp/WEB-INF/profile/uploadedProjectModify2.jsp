...
<div class="ProjectEditorWrap">
	<div class="Contents">
		<div class="ProjectMainWrap">
			<div class="AuditButtonWrap">
				<button class="LineButton__Button-sc-1ozfxit-0 fVUiy pdc-btn-l" color="grayEditor200">
					<div name="info-line-oval" class="Icon__SVGICON-sc-1xkf9cp-0 ccxeYs">
